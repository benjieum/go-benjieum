...
type wizard struct {
	...
	services map[string][]string   // Benjieum services known to be running on servers
...
// converts it to an Benjieum address. If an empty line is entered, the default
// value is returned.
