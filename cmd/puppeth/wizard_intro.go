...
// setting up a new or managing an existing Benjieum private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Benjieum private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Benjieum network down to  |")
	...
	log.Info("Administering Benjieum network", "name", w.network)
