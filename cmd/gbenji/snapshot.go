// Copyright 2021 The go-benjieum Authors
...
import (
	...
	"github.com/benjieum/go-benjieum/core/state/snapshot"
	...
	"github.com/benjieum/go-benjieum/trie"
...
var (
	snapshotCommand = &cli.Command{
		...
		Subcommands: []*cli.Command{
			{
				Name:      "prune-state",
				Usage:     "Prune stale benjieum state data based on the snapshot",
				ArgsUsage: "<root>",
				Action:    pruneState,
				...
				Description: `
gbenji snapshot prune-state <state-root>
...
during the use of Gbenji, please also specify it here for correct deletion. Otherwise
...
`,
			},
			{
				...
				Description: `
gbenji snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
gbenji snapshot check-dangling-storage <state-root> traverses the snap storage 
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
gbenji snapshot inspect-account <address | hash> checks all snapshot layers and prints out
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
gbenji snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
gbenji snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'gbenji dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'gbenji dump', but uses the snapshots
