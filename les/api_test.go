...
import (
	...
	ethdownloader "github.com/benjieum/go-benjieum/eth/downloader"
	...
	"github.com/benjieum/go-benjieum/p2p/simulations"
	"github.com/benjieum/go-benjieum/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	benjieum, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, benjieum, &config)
	if err != nil {
		return nil, err
	}
	return benjieum, nil
