...
import (
	...
	"github.com/benjieum/go-benjieum/accounts/abi/bind/backends"
	...
	"github.com/benjieum/go-benjieum/contracts/checkpointoracle/contract"
	...
	"github.com/benjieum/go-benjieum/les/checkpointoracle"
	"github.com/benjieum/go-benjieum/les/flowcontrol"
	vfs "github.com/benjieum/go-benjieum/les/vflux/server"
...
func prepare(n int, backend *backends.SimulatedBackend) {
	...
	for i := 0; i < n; i++ {
		...
		case 0:
			...
			// bankUser transfers some benji to user1
		...
		case 1:
			...
			// bankUser transfers more benji to user1
		...
		case 2:
			...
			// bankUser transfer some benji to signer
			bankNonce, _ := backend.PendingNonceAt(ctx, bankAddr)
