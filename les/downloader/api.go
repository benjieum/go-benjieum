...
// Syncing provides information when this nodes starts synchronising with the Benjieum network and when it's finished.
...
type SyncingResult struct {
	...
	Status  benjieum.SyncProgress `json:"status"`
}
