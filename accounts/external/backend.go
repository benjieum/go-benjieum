...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain benjieum.ChainStateReader) {
...
func (api *ExternalSigner) SignText(account accounts.Account, text []byte) ([]byte, error) {
	...
	if signature[64] == 27 || signature[64] == 28 {
		...
		// the signature to benjieum-type signature.
		signature[64] -= 27 // Transform V from Benjieum-legacy to 0/1
	}
