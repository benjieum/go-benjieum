...
//
// Detailed usage document and tutorial available on the go-benjieum Wiki page:
// https://github.com/benjieum/go-benjieum/wiki/Native-DApps:-Go-bindings-to-Benjieum-contracts
package bind
