...
import (
	...
	"github.com/benjieum/go-benjieum/internal/jsre"
...
func newTester(t *testing.T, confOverride func(*ethconfig.Config)) *tester {
	...
	// Create a networkless protocol stack and start an Benjieum service within
	...
	if err != nil {
		t.Fatalf("failed to register Benjieum protocol: %v", err)
	}
