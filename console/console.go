...
import (
	...
	"github.com/benjieum/go-benjieum/internal/jsre/deps"
	"github.com/benjieum/go-benjieum/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Benjieum requests through
...
// Welcome show summary of current Gbenji instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gbenji JavaScript console!\n\n"

	// Print some generic Gbenji metadata
