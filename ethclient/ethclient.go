...
// Client defines typed wrappers for the Benjieum RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) SyncProgress(ctx context.Context) (*benjieum.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (benjieum.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q benjieum.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q benjieum.FilterQuery, ch chan<- types.Log) (benjieum.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q benjieum.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg benjieum.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg benjieum.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg benjieum.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*benjieum.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg benjieum.CallMsg) (uint64, error) {
...
func toCallArg(msg benjieum.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *benjieum.SyncProgress {
	if p == nil {
		return nil
	}
	return &benjieum.SyncProgress{
