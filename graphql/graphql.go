...
// Account represents an Benjieum account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an Benjieum transaction.
...
// Block represents an Benjieum block.
...
type CallData struct {
	From                 *common.Address // The Benjieum address the call is from.
	To                   *common.Address // The Benjieum address the call is to.
...
type SyncState struct {
	progress benjieum.SyncProgress
}
