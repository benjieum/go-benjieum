...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Benjieum address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Benjieum account at a particular block.
    type Account {
    ...
    # Transaction is an Benjieum transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Benjieum account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Benjieum account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Benjieum block by number or by hash. If neither is
