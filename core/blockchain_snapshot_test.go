...
// It can be used for testing that restart Gbenji normally.
...
// It can be used for testing that restart Gbenji after the crash.
...
// Tests a Gbenji restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Gbenji was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Gbenji was crashed and restarts with a broken snapshot. In this case
...
// Tests a Gbenji was running with snapshot enabled. Then restarts without
...
// Tests the Gbenji was running with snapshot enabled and resetHead is applied.
...
// Tests the Gbenji was running with a complete snapshot and then imports a few
