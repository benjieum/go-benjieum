...
// NewID calculates the Benjieum fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Benjieum fork ID from an existing chain instance.
