...
pruning. Remember don't start the Gbenji without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "gbenji snapshot prune-state --help" for more details.
`
