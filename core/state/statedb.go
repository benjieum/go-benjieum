...
// StateDB structs within the benjieum protocol are used to store anything
...
//
// Carrying over the balance ensures that Benji doesn't disappear.
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/benjieum/go-benjieum/pull/16485#issuecomment-380438527),
