...
// Header represents a block header in the Benjieum blockchain.
type Header struct {
...
// Block represents an entire block in the Benjieum blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the Benjieum
...
// EncodeRLP serializes b into the Benjieum RLP block format.
