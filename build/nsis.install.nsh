Name "gbenji ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/benjieum/go-benjieum/issues"
!define UPDATEURL "https://github.com/benjieum/go-benjieum/releases"
!define ABOUTURL "https://github.com/benjieum/go-benjieum#benjieum-go"
...
# Install gbenji binary
Section "Gbenji" GBENJI_IDX
  SetOutPath $INSTDIR
  file {{.Gbenji}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gbenji.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gbenji.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gbenji incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gbenji outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gbenji UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gbenji incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gbenji.exe" "" "" "Benjieum" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gbenji outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gbenji.exe" "" "" "Benjieum" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gbenji UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gbenji.exe" "" "" "Benjieum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPS/issues/147)
  ${EnvVarUpdate} $0 "BENJIEUM_SOCKET" "R" "HKLM" "\\.\pipe\gbenji.ipc"
  ${EnvVarUpdate} $0 "BENJIEUM_SOCKET" "A" "HKLM" "\\.\pipe\gbenji.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GBENJI_IDX}
    SectionGetSize ${GBENJI_IDX} $0
