...
# 1. install gbenji for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gbenji
# 5. create gbenji, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable BENJIEUM_SOCKET
...
!define GROUPNAME "Benjieum"
!define APPNAME "Gbenji"
!define DESCRIPTION "Official Go implementation of the Benjieum protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gbenji is installed global
