...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gbenji.ipc", false, filepath.Join(os.TempDir(), "gbenji.ipc")},
		{"data", "gbenji.ipc", false, "data/gbenji.ipc"},
		{"data", "./gbenji.ipc", false, "./gbenji.ipc"},
		{"data", "/gbenji.ipc", false, "/gbenji.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gbenji.ipc", true, `\\.\pipe\gbenji.ipc`},
		{"data", "gbenji.ipc", true, `\\.\pipe\gbenji.ipc`},
		{"data", `\\.\pipe\gbenji.ipc`, true, `\\.\pipe\gbenji.ipc`},
	}
