...
// all blocks' seal as valid, though they still have to conform to the Benjieum
// consensus rules.
...
// still have to conform to the Benjieum consensus rules.
...
// they still have to conform to the Benjieum consensus rules.
