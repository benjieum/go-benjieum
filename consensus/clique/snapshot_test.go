...
// mapped from textual names used in the tests below to actual Benjieum private
...
// address retrieves the Benjieum address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Benjieum address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/benjieum/go-benjieum/issues/17593). Whilst this
