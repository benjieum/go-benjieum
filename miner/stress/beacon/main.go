...
import (
	...
	"github.com/benjieum/go-benjieum/core/beacon"
...
type ethNode struct {
	...
	ethBackend *eth.Benjieum
	lapi       *lescatalyst.ConsensusAPI
	lesBackend *les.LightBenjieum
}
...
func makeFullNode(genesis *core.Genesis) (*node.Node, *eth.Benjieum, *ethcatalyst.ConsensusAPI, error) {
	// Define the basic configurations for the Benjieum node
	...
	// Create the node and configure a full Benjieum node on it
...
func makeLightNode(genesis *core.Genesis) (*node.Node, *les.LightBenjieum, *lescatalyst.ConsensusAPI, error) {
	// Define the basic configurations for the Benjieum node
	datadir, _ := os.MkdirTemp("", "")
