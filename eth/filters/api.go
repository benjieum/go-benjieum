...
// information related to the Benjieum protocol such als blocks, transactions and logs.
...
func (api *FilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(benjieum.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as benjieum.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria benjieum.FilterQuery
...
func (api *FilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	...
	logsSub, err := api.events.SubscribeLogs(benjieum.FilterQuery(crit), logs)
	if err != nil {
		return "", err
	}
