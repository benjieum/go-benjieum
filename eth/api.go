...
// BenjieumAPI provides an API to access Benjieum full node-related information.
type BenjieumAPI struct {
	e *Benjieum
}

// NewBenjieumAPI creates a new Benjieum protocol API for full nodes.
func NewBenjieumAPI(e *Benjieum) *BenjieumAPI {
	return &BenjieumAPI{e}
}

// Etherbase is the address that mining rewards will be send to.
func (api *BenjieumAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase).
func (api *BenjieumAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate.
func (api *BenjieumAPI) Hashrate() hexutil.Uint64 {
	return hexutil.Uint64(api.e.Miner().Hashrate())
}

// Mining returns an indication if this node is currently mining.
func (api *BenjieumAPI) Mining() bool {
...
func NewMinerAPI(e *Benjieum) *MinerAPI {
	return &MinerAPI{e}
}
...
// AdminAPI is the collection of Benjieum full node related APIs for node
// administration.
...
func NewAdminAPI(eth *Benjieum) *AdminAPI {
...
// DebugAPI is the collection of Benjieum full node APIs for debugging the
// protocol.
...
func NewDebugAPI(eth *Benjieum) *DebugAPI {
