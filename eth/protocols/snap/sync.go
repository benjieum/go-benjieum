...
import (
	...
	"github.com/benjieum/go-benjieum/p2p/msgrate"
...
// Syncer is an Benjieum account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the Benjieum state over the
// snap protocol.
